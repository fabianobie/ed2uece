...
public class HashingMeioAbertoGUI extends JPanel {
	...
	public HashingMeioAbertoGUI() {
		initObjs();
		setProperties();
	}
	
	private void initObjs() {
		title = new JLabel("Hashing Meio Aberto", JLabel.LEFT);
		titlePanel = new JPanel();
	
		graph = EdManager.getGraphInstance();
		staticLayout = new StaticLayout<String, String>(graph);
		hashingMeioAbertoVV = new VisualizationViewer<String, String>(staticLayout,
	...
	private void setProperties() {
		...
		add(hashingMeioAbertoVV);
		hashingMeioAbertoVV.setBounds(2, 28, EdManager.VV_WIDTH, EdManager.VV_HEIGHT);
	}
	
	public void addGraphMouse(DefaultModalGraphMouse<String, String> graphMouse) {
		hashingMeioAbertoVV.setGraphMouse(graphMouse);
	}
	
	public VisualizationViewer<String, String> getHashingMeioAbertoVV() {
		return hashingMeioAbertoVV;
	}
	...
	public static void main(String[] args) {
		...
		HashingMeioAbertoGUI bG = new HashingMeioAbertoGUI();
		frame.add(bG);
