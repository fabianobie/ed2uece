...
public class HashingClosedGUI extends JPanel {
	...
	public HashingClosedGUI() {
		initObjs();
		setProperties();
	}
	
	private void initObjs() {
		title = new JLabel("Closed Hashing", JLabel.LEFT);
		titlePanel = new JPanel();
	
		graph = EdManager.getGraphInstance();
		staticLayout = new StaticLayout<String, String>(graph);
		closeHashingVV = new VisualizationViewer<String, String>(staticLayout,
	...
	private void setProperties() {
		...
		add(closeHashingVV);
		closeHashingVV.setBounds(2, 28, EdManager.VV_WIDTH, EdManager.VV_HEIGHT);
	}
	
	public void addGraphMouse(DefaultModalGraphMouse<String, String> graphMouse) {
		closeHashingVV.setGraphMouse(graphMouse);
	}
	
	public VisualizationViewer<String, String> getClosedHashingVV() {
		return closeHashingVV;
	}
	...
	public static void main(String[] args) {
		...
		HashingClosedGUI bG = new HashingClosedGUI();
		frame.add(bG);
