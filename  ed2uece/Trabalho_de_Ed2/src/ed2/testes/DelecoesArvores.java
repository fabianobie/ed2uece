...
//	private long tempoInicial,tempoFinal,mediaDeTempo;
	...
	public static void main(String[] args){
		...
		DelecoesArvores.delecaoCostanteAvl(quantidadeDeElementos, quantidadeDeTestes);
		DelecoesArvores.delecaoNormalAvl(quantidadeDeElementos, quantidadeDeTestes);
		DelecoesArvores.delecaoPoissonAvl(quantidadeDeElementos, quantidadeDeTestes);
		//Testes realizados para Splay
		DelecoesArvores.delecaoCostanteSplay(quantidadeDeElementos, quantidadeDeTestes);
		DelecoesArvores.delecaoNormalSplay(quantidadeDeElementos, quantidadeDeTestes);
		DelecoesArvores.delecaoPoissonSplay(quantidadeDeElementos, quantidadeDeTestes);		
	...
	public static void delecaoCostanteAvl(int quantidadeDeElementos,int quantidadeDeTestes){
		...
		try {
			...
			while(contador > quantidadeDeElementos){
				...
				for (int i = 0; i < quantidadeDeElementos; i++) {
					...
					avlControler.removerAvl(avl,chave);
				}
	...
	public static void delecaoPoissonAvl(int quantidadeDeElementos,int quantidadeDeTestes){
		long tempoInicial, tempoFinal, mediaDeTempo = 0;
		File file;
		FileInputStream fileReader;
	...
	public static void delecaoNormalAvl(int quantidadeDeElementos,int quantidadeDeTestes){
		long tempoInicial, tempoFinal, mediaDeTempo = 0;
		File file;
		FileInputStream fileReader;
	...
	public static void delecaoCostanteSplay(int quantidadeDeElementos,int quantidadeDeTestes){
		long tempoInicial, tempoFinal, mediaDeTempo = 0;
		File file;
		FileInputStream fileReader;
		file = new File("C:/Users/Wellington/Desktop/WorkSpaceGalileu2/Trabalho_de_Ed2/bin/ed2/testes/constante.txt");
		try {
			...
			while(contador > quantidadeDeElementos){
				...
				for (int i = 0; i < quantidadeDeElementos; i++) {
					...
					splayControler.deletaSplay(splay, chave);
				}
				tempoFinal  = System.currentTimeMillis() - tempoInicial;
				mediaDeTempo =+ tempoFinal; 
			}
	...
	public static void delecaoPoissonSplay(int quantidadeDeElementos,int quantidadeDeTestes){
		long tempoInicial, tempoFinal, mediaDeTempo = 0;
		File file;
		FileInputStream fileReader;
		file = new File("C:/Users/Wellington/Desktop/WorkSpaceGalileu2/Trabalho_de_Ed2/bin/ed2/testes/poisson.txt");
	...
	public static void delecaoNormalSplay(int quantidadeDeElementos,int quantidadeDeTestes){
		long tempoInicial, tempoFinal, mediaDeTempo = 0;
		File file;
		FileInputStream fileReader;
		file = new File("C:/Users/Wellington/Desktop/WorkSpaceGalileu2/Trabalho_de_Ed2/bin/ed2/testes/normal.txt");
